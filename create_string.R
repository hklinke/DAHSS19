...
generateTweetText = function(artist, title, question, word) {
  hashtag = paste("#", word, "")
  question = paste(question, hashtag, " ")
  tweet_text = paste(artist, title, "@Thyssenmalaga", question, sep = "\n")
}
...
carmen_data_utf.8$tweet_body = generateTweetText(artists, titles, questions, hashtags)
